...
# Driver Code
T = input("Enter Text: ")
P = input("Enter Pattern to search for: ")
search(T,P)

"""
Time Complexity :
O(m+n) where m = length of pattern 
             n = length of text
Sample Input1 
Enter text :abcabdeba
Enter Pattern to search for : abc
Output:
Pattern Found at Index 0
Number of times Pattern occurs in string: 1
"""
